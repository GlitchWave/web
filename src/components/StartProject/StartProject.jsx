  ...
  return (
    <section className="start-project">
      <div
        ...
        style={{
          backgroundImage:
            'url(https://image.ibb.co/n1Kfyo/banner_1366_768.png[/img])'
        }}
      >
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url(https://image.ibb.co/dpPur8/meeting_banner.png[/img])'
        }}
      >
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url(https://image.ibb.co/iAbz8o/project_plan_banner.png[/img])'
        }}
      >
      ...
      <div className="start-project--ux">
      ...
      <div className="start-project--development">
        <h3 className="typicla--h3">DEVELOPMENT</h3>
        <p className="typical--p">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation ullamco laboris nisi ut
      ...
      <div className="start-project--QA">
      ...
      <div className="start-project--delivering">
      ...
      <div className="start-project--support">
